...
const Login = (props) => {
  ...
  const onFormSubmit = (e) => {
    ...
    props.loginUser(user, props.history, startStopLoading, props.redirectTo);
  };
                ...
                <div className="col-md-7 col-sm-12 col-12 login-left-section">
                  ...
                  <div className="login-form">
                      ...
                      <div className="form-group text-center">
                        <label className="animate__animated animate__backInDown animate__delay-1s">SIGN IN</label>
                      </div>
                      {state.errors.auth ? (
